...
Command: npx gltfjsx@6.1.4 public/models/Dragon_Evolved.gltf --output src/components/Dragon_Evolved.jsx -r public
*/
...
export function Dragon({ hovered, Animations, ...props }) {
  const group = useRef();
  const { nodes, materials, animations } = useGLTF(
    "/models/Dragon_Evolved.gltf"
  );
  const { actions } = useAnimations(animations, group);
  const anim = hovered ? Animations.Heatbutt : Animations.FlyingIdle;
